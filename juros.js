...
que recebe C (capital), i (juros em decimal. ex: 3,5% = 0.035) e t (tempo). 
...
Crie uma nova função que dado as mesmas variáveis do 
exercício anterior, retorne o montante total C + juros simples.
*/
...
O exercício anterior já retorna o montante 
(capital + juros). Crie uma função em juros.js que retorne somente os juros.

(ps: para realizar testes unitários de funções que dependam 
    de outras funções - é importante assistir a aula - Injeção de dependências)
*/
